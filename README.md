...
- 2024.04: 픽셀 단위 손상 영역 라벨링(LabelMe) 진행
...
등급 분류 결과만으로는 손상 위치를 확인할 수 없습니다. 2024년 4월에 LabelMe로 차선 영역과 개별 손상 부위를 폴리곤으로 라벨링해뒀었는데, 당시엔 다른 서버에 있던 데이터라 활용하지 못했습니다. 2026년 9월에 데이터를 다시 확보해서, 이를 이진 마스크로 변환해 U-Net을 학습했습니다.
